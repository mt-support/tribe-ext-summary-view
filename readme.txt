...
= Is this view customizable? =

Yes! The Summary View uses the same [templating system](https://theeventscalendar.com/knowledgebase/k/calendar-template-files-v2/) as our default views, so customizations are just as easy!
