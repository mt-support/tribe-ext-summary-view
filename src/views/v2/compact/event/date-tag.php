<?php
/**
 * View: Compact View - Single Event Date Tag
 *
 * Override this template in your own theme by creating a file at:
 * [your-theme]/tribe/events/v2/compact/event/date-tag.php
 *
...
if ( empty( $is_past ) && ! empty ( $request_date ) ) {
	$should_have_date_tag = Utils\Separators::should_have_date( $this->get( 'events' ), $event, $request_date );
} else {
	$should_have_date_tag = Utils\Separators::should_have_date( $this->get( 'events' ), $event );
}
...
<div class="tribe-events-calendar-list__event-date-tag tribe-common-g-col">
	<time class="tribe-events-calendar-list__event-date-tag-datetime" datetime="<?php echo esc_attr( $event_date_attr ); ?>">
		<span class="tribe-events-calendar-list__event-date-tag-weekday">
			<?php echo $should_have_date_tag ? esc_html( $event_week_day ) : ''; ?>
		</span>
		<span class="tribe-events-calendar-list__event-date-tag-daynum tribe-common-h5 tribe-common-h4--min-medium">
			<?php echo $should_have_date_tag ? esc_html( $event_day_num ) : ''; ?>
		</span>
	</time>
</div>
