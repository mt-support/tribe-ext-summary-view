<?php
/**
 * View: Compact View Date grouping
 *
 ...
 * @version 1.0.0
 *
 * @var string             $date            The date for the date group.
...
<div <?php tribe_classes( $container_classes ); ?>>
	...
	<?php $this->template( 'compact/event/date-tag', [ 'event' => $event ] ); ?>

	<div class="tribe-events-calendar-compact__event-wrapper tribe-common-g-col">
		<?php foreach ( $events_for_date as $event ) : ?>
			<?php $this->setup_postdata( $event ); ?>
			<?php $this->template( 'compact/event', [ 'event' => $event ] ); ?>
		<?php endforeach; ?>
	</div>
